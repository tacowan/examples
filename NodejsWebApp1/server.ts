...
const secret = "ULRp4idYw83Y1NU2DS9S0M8";
const appid = "efb5564e-1f63-4607-be77-60e397dc9ef9";
const redirect_uri = "http://localhost:1337/myapp";
...
const oauthEndpoint = "https://login.microsoftonline.com/common/oauth2/v2.0";
